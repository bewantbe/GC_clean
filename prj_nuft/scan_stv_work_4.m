...
% _ST _expIF
signature = 'data_scan_stv/net_2_2_IF_sc2_l1e7_w4';  % to distinguish different parallel program instances (also dir)
...
for id_stv = 1:length(s_stv)
    ...
    [X1,X2,T1,T2] = SampleNonUnif(oX, mlen, slen, '0', simu_time/T_segment*stv/s_stv(1));
